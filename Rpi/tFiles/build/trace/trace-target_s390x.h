...
static inline void _nocheck__trace_ioinst(const char * insn)
{
    if (trace_event_get_state(TRACE_IOINST) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 8 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:ioinst " "IOINST: %s" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , insn);
#line 132 "trace/trace-target_s390x.h"
        } else {
#line 8 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("ioinst " "IOINST: %s" "\n", insn);
#line 136 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_ioinst_sch_id(const char * insn, int cssid, int ssid, int schid)
{
    if (trace_event_get_state(TRACE_IOINST_SCH_ID) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 9 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:ioinst_sch_id " "IOINST: %s (%x.%x.%04x)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , insn, cssid, ssid, schid);
#line 163 "trace/trace-target_s390x.h"
        } else {
#line 9 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("ioinst_sch_id " "IOINST: %s (%x.%x.%04x)" "\n", insn, cssid, ssid, schid);
#line 167 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_ioinst_chp_id(const char * insn, int cssid, int chpid)
{
    if (trace_event_get_state(TRACE_IOINST_CHP_ID) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 10 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:ioinst_chp_id " "IOINST: %s (%x.%02x)" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , insn, cssid, chpid);
#line 194 "trace/trace-target_s390x.h"
        } else {
#line 10 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("ioinst_chp_id " "IOINST: %s (%x.%02x)" "\n", insn, cssid, chpid);
#line 198 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_ioinst_chsc_cmd(uint16_t cmd, uint16_t len)
{
    if (trace_event_get_state(TRACE_IOINST_CHSC_CMD) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 11 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:ioinst_chsc_cmd " "IOINST: chsc command 0x%04x, len 0x%04x" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cmd, len);
#line 225 "trace/trace-target_s390x.h"
        } else {
#line 11 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("ioinst_chsc_cmd " "IOINST: chsc command 0x%04x, len 0x%04x" "\n", cmd, len);
#line 229 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_kvm_enable_cmma(int rc)
{
    if (trace_event_get_state(TRACE_KVM_ENABLE_CMMA) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 14 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_enable_cmma " "CMMA: enabling with result code %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , rc);
#line 256 "trace/trace-target_s390x.h"
        } else {
#line 14 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("kvm_enable_cmma " "CMMA: enabling with result code %d" "\n", rc);
#line 260 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_kvm_clear_cmma(int rc)
{
    if (trace_event_get_state(TRACE_KVM_CLEAR_CMMA) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 15 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_clear_cmma " "CMMA: clearing with result code %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , rc);
#line 287 "trace/trace-target_s390x.h"
        } else {
#line 15 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("kvm_clear_cmma " "CMMA: clearing with result code %d" "\n", rc);
#line 291 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_cpu_set_state(int cpu_index, uint8_t state)
{
    if (trace_event_get_state(TRACE_CPU_SET_STATE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 20 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:cpu_set_state " "setting cpu %d state to %" PRIu8 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cpu_index, state);
#line 380 "trace/trace-target_s390x.h"
        } else {
#line 20 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("cpu_set_state " "setting cpu %d state to %" PRIu8 "\n", cpu_index, state);
#line 384 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_cpu_halt(int cpu_index)
{
    if (trace_event_get_state(TRACE_CPU_HALT) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 21 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:cpu_halt " "halting cpu %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cpu_index);
#line 411 "trace/trace-target_s390x.h"
        } else {
#line 21 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("cpu_halt " "halting cpu %d" "\n", cpu_index);
#line 415 "trace/trace-target_s390x.h"
        }
    }
}
...
static inline void _nocheck__trace_cpu_unhalt(int cpu_index)
{
    if (trace_event_get_state(TRACE_CPU_UNHALT) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 22 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("%d@%zu.%06zu:cpu_unhalt " "unhalting cpu %d" "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cpu_index);
#line 442 "trace/trace-target_s390x.h"
        } else {
#line 22 "/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/target/s390x/trace-events"
            qemu_log("cpu_unhalt " "unhalting cpu %d" "\n", cpu_index);
#line 446 "trace/trace-target_s390x.h"
        }
    }
}
