...
all:
GIT=git
GIT_SUBMODULES=ui/keycodemapdb tests/fp/berkeley-testfloat-3 tests/fp/berkeley-softfloat-3 meson capstone slirp
...
PKGVERSION=
SRC_PATH=/home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl
TARGET_DIRS=aarch64-linux-user
CONFIG_PIPE2=y
CONFIG_ACCEPT4=y
CONFIG_SPLICE=y
CONFIG_EVENTFD=y
...
MESON=/usr/bin/python3 -B /home/andrew/FYP/AFL++/AFLplusplus/qemu_mode/qemuafl/meson/meson.py
NINJA=/usr/bin/ninja
CC=cc
CXX=c++
OBJCC=clang
