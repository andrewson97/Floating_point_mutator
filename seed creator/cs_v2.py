...
def generate_input():
  ...
  rv = random.choice(random_values)
  re = random.choice([float('NaN'), float('Infinity'), float('-Infinity'),1.1754943508222875e-38, -1.1754943508222875e-38])

  #return random.choice([special_values, boundary_values, random_values])
  return random.choice([re, rv])
